...
- ช่อง **รหัสผ่าน** — ตัวเลข 6 หลักเท่านั้น (ถ้าใส่ไม่ครบจะเตือนให้ใส่ครบ)
- ปุ่ม **เข้าสู่ระบบ** (สีเข้ม)
- ปุ่ม/ลิงก์ **ลงทะเบียน** (สีเทา) ด้านล่าง

### 4.3 หน้าลงทะเบียน (`/register`)
- รหัส 10 หลัก, รหัสผ่าน (ตัวเลข 6 หลัก), ยืนยันรหัสผ่าน
...
- รหัสผ่าน = ตัวเลข 6 หลักเท่านั้น (ต้องใส่ครบ)
